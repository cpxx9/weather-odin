...
export {};`, "",{"version":3,"sources":["webpack://./src/CSS/reset.css"],"names":[],"mappings":"AAAA;QACQ,CAAA","sourcesContent":["// extracted by mini-css-extract-plugin\nexport {};"],"sourceRoot":""}]);
// Exports
...
var style = __webpack_require__(445);
...
// EXTERNAL MODULE: ./node_modules/css-loader/dist/cjs.js!./node_modules/mini-css-extract-plugin/dist/loader.js!./node_modules/css-loader/dist/cjs.js!./src/CSS/reset.css
var CSS_reset = __webpack_require__(99);
;// CONCATENATED MODULE: ./src/CSS/reset.css
...
function abbrState(input, to) {
  ...
  if (to === 'abbr') {
    ...
    for (var _i = 0; _i < states.length; _i += 1) {
      if (states[_i][1] === input) {
        return states[_i][0];
      }
    }
  }
...
function _getWeather() {
  _getWeather = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var response, data;
...
function _getLocation() {
  _getLocation = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var location,
      locations,
      response,
      data,
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 12:
          locations.push.apply(locations, _toConsumableArray(data));
...
function processWeatherData(data) {
  ...
  var proccessedWeatherData = [];
  forecast.forEach(function (day) {
    proccessedWeatherData.push({
      icon: "".concat(day.day.condition.icon),
      avgtemp: "".concat(day.day.avgtemp_f),
      text: "".concat(day.day.condition.text),
      mintemp: "".concat(day.day.mintemp_f),
      maxtemp: "".concat(day.day.maxtemp_f)
    });
  });
  return proccessedWeatherData;
}
function displayWeather(data) {
  var newData = processWeatherData(data);
  ...
  forecastCards.forEach(function (card) {
    ...
    newCard.children[4].textContent = "Low: ".concat(newData[newCard.dataset.id].mintemp);
    newCard.children[5].textContent = "High: ".concat(newData[newCard.dataset.id].maxtemp);
  });
}
function displaySearchResults(locationArray) {
  var domContainer = document.querySelector('.results-container');
  ...
  if (locationArray.length !== 0) {
    ...
    locationArray.forEach(function (location, index) {
      var abbr = abbrState(location.region, 'abbr');
      var locationWrapper = document.createElement('li');
      locationWrapper.classList.add('location-list-item');
      locationWrapper.dataset.locationIndex = index;
      locationWrapper.textContent = "".concat(location.name, ", ").concat(abbr !== undefined ? abbr : location.region);
...
searchInput.addEventListener('input', function (e) {
  if (e.target.value) {
    getLocation(e.target.value).then(function (data) {
      locations = _toConsumableArray(data);
...
document.addEventListener('click', function (e) {
  if (e.target.className === 'location-list-item') {
    getWeather("id:".concat(locations[e.target.dataset.locationIndex].id)).then(function (data) {
